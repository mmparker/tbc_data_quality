...
plans$days_open <- Sys.Date() - plans$treat_plan_date
...
plans$open_too_long <- FALSE
plans$open_too_long[plans$ltbi_drug %in% "RIF" & plans$days_open > 124] <- TRUE
plans$open_too_long[plans$ltbi_drug %in% "INH" & plans$days_open > 279] <- TRUE
plans$open_too_long[plans$ltbi_drug %in% "INH/Rifapentine" & plans$days_open > 84] <- TRUE
plans$open_too_long[plans$ltbi_drug %in% "INH" & plans$days_open > 365] <- TRUE

open_too_long <- subset(plans,
