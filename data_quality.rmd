...
<div id="tabs">
  ...
  <h2>Treatment Plan/Classification Mismatch</h2>
  ...
  <h2>Patients with 2 or More Open Treatment Plans</h2>
  ```{r multiplan}
  ...
  <h2>Treatment Plans Open Longer Than Expected</h2>
  ```{r plans_open_longer}
  ...
  dfprintif(arrange(open_too_long, plan_author, treat_plan_type, ltbi_drug, desc(days_open)),
  ...
  <h2>Treatment Plans Closed Without Reason or End Date</h2>
  ```{r closed_without}
  ...
  <h2>Open Treatment Plans with Reason Stopped or End Date</h2>
  ```{r open_with}
  ...
  <h2>Incomplete LTBI Pickups in the Past Fourteen Days</h2>
  ```{r missed_pickups}
  ...
  <h2>Suspects Open for More Than 90 Days</h2>
  ```{r overdue_suspects}
  ...
  <h2>TSTs with Missing Results</h2>
  ...
  <h2>QFTs with Missing Results</h2>
  ...
  <h2>Clinical Encounters with No Staff Responsible</h2>
  ...
  <h2>Addresses with No County</h2>
  ```{r no_county}
